...
import com.power.suntechpower.databinding.ActivityOfficialAnnouncementBinding

class Official_Announcement_Activity : BaseActivity() {

    lateinit var binding : ActivityOfficialAnnouncementBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_official_announcement)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_official_announcement)
