...
import com.power.suntechpower.databinding.ActivityInCardBinding

class InCard_Activity : AppCompatActivity() {
    lateinit var binding : ActivityInCardBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_in_card)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_in_card)
