...
import com.power.suntechpower.databinding.ActivityChangePasswordViewBinding

class Change_password_view : AppCompatActivity() {
    lateinit var binding: ActivityChangePasswordViewBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_change_password_view)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_change_password_view)
