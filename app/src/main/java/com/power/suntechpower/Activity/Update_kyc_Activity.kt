...
import com.power.suntechpower.databinding.ActivityUpdateKycBinding

class Update_kyc_Activity : AppCompatActivity() {
    lateinit var binding : ActivityUpdateKycBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_update_kyc)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_update_kyc)

        binding.updatebutton.setOnClickListener {
            startActivity(Intent(this,UpdateKyc_Form_Activity::class.java))
        }
