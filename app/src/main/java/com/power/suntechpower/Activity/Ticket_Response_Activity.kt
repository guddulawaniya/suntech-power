...
import com.power.suntechpower.databinding.ActivityTicketResponseBinding

class Ticket_Response_Activity : AppCompatActivity() {

    lateinit var binding : ActivityTicketResponseBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ticket_response)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_ticket_response)
