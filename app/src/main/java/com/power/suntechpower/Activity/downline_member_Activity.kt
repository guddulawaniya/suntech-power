...
import com.power.suntechpower.databinding.ActivityDownlineMemberBinding
import java.util.Calendar

class downline_member_Activity : AppCompatActivity() {
    lateinit var binding: ActivityDownlineMemberBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_downline_member)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_downline_member)
