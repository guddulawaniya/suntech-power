...
import com.power.suntechpower.databinding.FragmentRejectLeadBinding

class RejectLeadFragment : Fragment() {


    lateinit var binding : FragmentRejectLeadBinding

    private lateinit var rejectleadList: List<RejectLeadsResponse>
    ...
    override fun onCreateView(
        ...
        binding = FragmentRejectLeadBinding.inflate(inflater, container, false)


        arguments?.let {
            rejectleadList = it.getSerializable("rejectleads") as List<RejectLeadsResponse>
        }
        setTableData()
