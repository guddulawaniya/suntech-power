...
import com.power.suntechpower.databinding.FragmentApprovedLeadsBinding


class Approved_LeadsFragment : Fragment() {

    lateinit var binding : FragmentApprovedLeadsBinding

    private lateinit var approveleadList: List<ApproveLeadsResponse>

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentApprovedLeadsBinding.inflate(inflater, container, false)

        arguments?.let {
            approveleadList = it.getSerializable("approvedleads") as List<ApproveLeadsResponse>
        }
